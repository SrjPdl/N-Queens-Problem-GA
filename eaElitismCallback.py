...
def eaElitismCallback(population, toolbox, cxpb, mutpb, ngen, callback=None, stats=None,
    ...
    2. a callback argument was added. It represents an external function that will be called after
       each iteration, passing the current generation number, max generations and the current best individual as arguments
    """
    ...
    for gen in range(1, ngen + 1):
        ...
        if callback:
            callback(gen, halloffame.items[0], ngen)
